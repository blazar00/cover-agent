...
class TestUnitTestGenerator:
    ...
    def test_get_code_language_java(self):
        with tempfile.NamedTemporaryFile(
            ...
            language = generator.get_code_language(temp_source_file.name)
        ...
        with tempfile.NamedTemporaryFile(
            ...
            with tempfile.NamedTemporaryFile(
                ...
                with patch.object(
                    ...
                    report_path = generator.generate_diff_coverage_report()
                    assert (
                        report_path
                        == f"{generator.test_command_dir}/diff-cover-report.json"
                    )
